(function () {
    ...
    angular
        .module('vk')
        .controller('heyteaRechargeController', heyteaRechargeController);

    /** @ngInject */
    heyteaRechargeController.$inject = ['$location', '$timeout', 'UtilService', 'MyService', '$sessionStorage', "lodash", "SessionStorageService"];

    function heyteaRechargeController($location, $timeout, UtilService, MyService, $sessionStorage, lodash, SessionStorageService) {
